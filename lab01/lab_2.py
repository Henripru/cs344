...
problem = {
    ...
    'initialA': ['space on table', 'b on table', 'space on b', 'a on table', 'c on a', 'space on c'],
    'goalA': ['b on table', 'a on table', 'c on table'],

    'initialB': ['a on table', 'b on table', 'c on table', 'space on a', 'space on b', 'space on c'],
